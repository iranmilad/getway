                            ...
                            if ($wcHolooCode == $HolooProd->a_Code) {
                                ...
                                ((isset($this->config->update_product_name) && $this->config->update_product_name=="1") && $WCProd->name != trim($this->arabicToPersian($HolooProd->name)))
                                    ...
                                    $data = [
                                        ...
                                        'stock_quantity' => (isset($this->config->update_product_stock) && $this->config->update_product_stock=="1" && $this->get_exist_type($this->config->product_stock_field,$HolooProd)>0 and isset($WCProd->stock_quantity)) ? $this->get_exist_type($this->config->product_stock_field,$HolooProd) : 0,
                                    ];
                            ...
                            if ($wcHolooCode == $HolooProd->a_Code) {
                                ...
                                ((isset($config->update_product_name) && $config->update_product_name=="1") && $WCProd->name != trim($this->arabicToPersian($HolooProd->name)))
                                    ...
                                    $data = [
                                        ...
                                        'stock_quantity' => (isset($config->update_product_stock) && $config->update_product_stock=="1") ? $this->get_exist_type($this->request["product_stock_field"],$HolooProd) : 0,
                                    ];
