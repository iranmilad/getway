                ...
                if ($wcHolooCode!=null) {
                    ...
                    foreach ($HolooProds as $key=>$HolooProd) {
                        ...
                        if ($wcHolooCode == $HolooProd->a_Code) {
                            ...
                            (isset($config->special_price_field) && (int)$WCProd->sale_price<(int)$WCProd->regular_price && (int)$WCProd->sale_price  != $this->get_price_type($config->special_price_field,$HolooProd)) or
                ...
                if ($wcHolooCode) {
                    ...
                    foreach ($holooProducts as $key=>$HolooProd) {
                        ...
                        if ($wcHolooCode == $HolooProd->a_Code) {
                            ...
                            ((isset($config->update_product_stock) && $config->update_product_stock=="1") &&  isset($WCProd->stock_quantity) and (int)$HolooProd->exist>0 and $WCProd->stock_quantity != (int)$HolooProd->exist) or
