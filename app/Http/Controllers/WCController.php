                        ...
                        foreach ($holooProducts->result as $HolooProd) {
                            if ($WCProd->meta_data[0]->value == $HolooProd->a_Code) {
                                ...
                                if (
                                    ...
                                    $test=[(int)$WCProd->regular_price,$this->get_price_type($config->sales_price_field,$HolooProd),((int)$WCProd->regular_price != $this->get_price_type($config->sales_price_field,$HolooProd))];
