                        ...
                        foreach ($holooProducts->result as $HolooProd) {
                            if ($WCProd->meta_data[0]->value == $HolooProd->a_Code) {
                                ...
                                if (
                                    ...
                                    return $this->sendResponse('همه محصولات به روز رسانی شدند.', Response::HTTP_OK, ((float)$WCProd->regular_price != (float)$this->get_price_type($config->sales_price_field,$HolooProd)));
